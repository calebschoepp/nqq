...
all: main.o chunk.o debug.o memory.o value.o vm.o compiler.o scanner.o object.o
	$(CC) main.o chunk.o debug.o memory.o value.o vm.o compiler.o scanner.o object.o -o nqq
...
vm.o: vm.c vm.h chunk.h common.h debug.h value.h object.h memory.h
...
object.o: object.c object.h common.h value.h memory.h vm.h
	$(CC) object.c $(CFLAGS) -o object.o

clean:
	@rm -f nqq main.o chunk.o debug.o memory.o value.o vm.o compiler.o scanner.o object.o
